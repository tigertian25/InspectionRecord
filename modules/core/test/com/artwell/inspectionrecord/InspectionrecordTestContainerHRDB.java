...
public class InspectionrecordTestContainerHRDB extends TestContainer {

    public InspectionrecordTestContainerHRDB() {
        super();
...
//        dbUrl = "jdbc:sqlserver://erp.artwell-hk.com;databaseName=HRDB";
//        dbUser = "hr";
//        dbPassword ="oms2009";
        dbDriver ="com.microsoft.sqlserver.jdbc.SQLServerDriver";
        dbUrl ="jdbc:sqlserver://erp.artwell-hk.com;databaseName=HRDB";
    ...
    public static class Common extends InspectionrecordTestContainerHRDB {

        public static final InspectionrecordTestContainerHRDB.Common INSTANCE = new InspectionrecordTestContainerHRDB.Common();
